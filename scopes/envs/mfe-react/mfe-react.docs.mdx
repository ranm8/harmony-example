...
```json
{
   "teambit.workspace/variants": {
     "{ui/*}": {
       "deepblue.scopes/envs/mfe-react": {}
     }
   }
}
```
...
### Theming
This environment adds the design theme [Theme](https://bit.dev/deepblue/design/theme-context) tp all compositions of the components that use this example env.
